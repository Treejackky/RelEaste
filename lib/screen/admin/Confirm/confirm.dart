...
class FinishScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: _ShowAll(imageFiles, latitude, longitude, district, amphoe,
          province, zipcode, formValues, body, sendRequest, buildUI, context),
    );
  }
}

Widget _ShowAll(imageFiles, latitude, longitude, district, amphoe, province,
    zipcode, formValues, body, sendRequest, buildUI, context) {
